...
export class SourceResolver {
  ...
  private identifierForObject = new Map<unknown, string>();
  ...
  private writeRefDep(ref: Ref) {
    ...
    this.identifierForObject.set(ref.data, id);
  ...
  writeObject(obj: {}): this {
    ...
    if (ref.stage === RefStage.WRITTING) {
      const id = this.identifierForObject.get(obj);
      this.writeCode(`{} /* recursive ${id} === ${ref.identifier} */`);
