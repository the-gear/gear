...
import { transpileModule } from './ts-transpiler';
import { TranspileOutput } from '../dist/ts-transpiler';
...
export class GqlFile extends Source {
  ...
  constructor(body: string, name: string, config: GraphqlTsConfig) {
    ...
    console.log(`[graphql-ts] processing ${this.getModuleName()}`);
  ...
  getModuleName(): string {
    ...
    // this.moduleName = config.rootDir ? relative(config.rootDir, name) : name;
  ...
  getTranspileOutput(): TranspileOutput {
    ...
    const transpileOutput = transpileModule(tsCode, {
      compilerOptions: {
        declaration: true,
        ...this.config.typescriptCompilerOptions,
      },
      fileName: this.name,
